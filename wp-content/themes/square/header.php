...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/nivosliderTheme/nivo-slider.css" />
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/nivosliderTheme/light.css" />
